# Assign Drivers to the Rock Wall Plane
...
def assignDrivers():
    ...
    d0 = {
        'object': object, 
        'property': 'Color1',
        'value': [0.010113, 0.006843, 0.002995, 1.000000],
    ...
    d3 = { 
        'object': object, 
        'property': 'Color2',
        'value': [0.076728, 0.045395, 0.013369, 1.000000],
    ...
    d6 = { 
        'object': object, 
        'property': 'Color3',
        'value': [0.571661, 0.423131, 0.123842, 1.000000],
    ...
    d20 = {
        'object': object,
        'property': 'BumpStrength',
        'value': 0.01,
        'driven_value': 'nodes["Bump"].inputs[0].default_value',
        'driven_object' : object.material_slots[0].material.node_tree,
        'index' : -1,
        'variable_name' : 'var',
        'data_path' : '["BumpStrength"]',
        'id_type' : 'OBJECT',
        'subtype': '',
        'min': 0,
        'max': 100,
